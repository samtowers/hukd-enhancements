...
function alterDeals(alterCB) {
  ...
  //let dealLocationMarker = document.querySelector('section.thread--type-list');
  dealParent.innerHTML = dealParent.innerHTML + updatedDealsHTML + '<div id="batchSeparator">Batch completed.</div>';
  
  //dealLocationMarker.outerHTML += updatedDealsHTML + '<div id="batchSeparator">Batch completed.</div>';
}
